...
### 5.5 2×2 세그먼트 맵 — 정산 마찰 × 디지털 정산수단 적용 가능성

5.1\~5.4는 통화 코리도와 기업 규모를 축으로 삼았다. 아래 매트릭스는 SOM을 좁힌 실제 판단 기준, 즉 "거래처가 겪는 정산 마찰의 크기"와 "디지털 정산수단을 적용할 수 있는 여건"을 두 축으로 세그먼트를 다시 배치한 것이다.

| **디지털 정산수단 적용 가능성** | **정산 마찰 낮음** | **정산 마찰 높음** |
|---|---|---|
| **높음** | **Q2. 효율 개선 시장**<br>주요 통화 중심 대기업·은행 우대조건 체결기업·ERP·TMS 구축 글로벌 기업<br>판단: 도입은 쉽지만 전환 유인 제한적<br>전략: 후순위·기능 확장 시장 | **Q1. 핵심 공략 시장**<br>반복거래 중소·중견 수출입기업·다수 거래처 관리 B2B 플랫폼·수작업 대사·증빙 부담기업<br>판단: 문제도 크고 솔루션 적용도 가능<br>전략: **SOM·MVP 핵심 시장** |
| **낮음** | **Q3. 비우선 시장**<br>비정기 해외거래 소기업·연간 송금 빈도·금액 낮은 기업·디지털 시스템 활용도 낮은 기업<br>판단: 도입비용 대비 편익 작음<br>전략: MVP 제외 | **Q4. 장기 잠재 시장**<br>자본통제·비태환 통화 거래기업·고위험·신흥시장 거래기업·현지 은행·유동성 연결 부족 코리도<br>판단: 문제는 크지만 규제·유동성·파트너 조건 미충족<br>전략: 장기 진입·파트너십 시장 |

Q1(정산 마찰 높음·적용 가능성 높음)만 SOM·MVP 핵심 시장으로 분류된다. Q2는 문제가 이미 완화돼 전환 유인이 낮고, Q4는 문제가 크지만 규제·유동성 조건이 아직 갖춰지지 않아 장기 과제로 남는다.

### 5.6 SOM으로 좁혀지는 조건

Q1 전체가 곧바로 SOM은 아니다. 다음 조건을 추가로 적용해 1년차 시장으로 좁힌다.

> 반복적인 USD↔KRW 거래를 수행하며, 비용·정산시점·추적·대사 문제를 겪고 있고, 파트너은행과 ERP/API 연결이 가능한 국내 중소·중견 수출입기업

통화 코리도(USD-KRW)와 기업 규모(중소·중견)는 1차 세그먼트 축이 아니라, Q1 내부에서 SOM을 구체화하는 2차 필터다.

한계: 아직 정량 조사 전 단계이므로 세그먼트에 임의의 좌표 점수(5.3절 quadrantChart 방식)를 부여하지 않았다 — 이 매트릭스는 사분면 배치까지만 반영한다.
