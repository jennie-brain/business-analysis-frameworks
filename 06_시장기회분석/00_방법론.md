...
- [~] DOS 확장 — Market Relevance 판단 → `03_MarketRelevance_판단.md`(페르소나 세그먼트별로 SOM 직접(0.35~1.0)·SAM 미계량(0.2 잠정)·SOM 제외 대기업(0.1 잠정) 3갈래로 구분, AOS 상위 5개 예시 계산까지 완료. 36개 전체 DOS 계산은 다음 회차)

## 참고자료

- `06_시장기회분석/01_Pain리스트_Goal추론.md` — 실제 Pain 리스트·Goal 추론 결과
- `06_시장기회분석/02_AOS매트릭스.md` — Importance·Satisfaction·AOS 산출 결과와 사분면 매트릭스
- `06_시장기회분석/03_MarketRelevance_판단.md` — DOS의 Market Relevance 파라미터 판단과 예시 계산
