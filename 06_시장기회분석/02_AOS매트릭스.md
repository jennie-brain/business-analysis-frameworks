...
|---|---|---|---|---|---|---|---|
| 1 | E1-② | 강태민★ | 컷오프 밀림 → 실패 | 5 | 1 | **4.0** | Q1 |
| 1 | E2-② | 배소연 | 마감 실제로 놓침 | 5 | 1 | **4.0** | Q1 |
| 3 | C1-① | 김민준★ | 도착시점 예측 불가 | 5 | 2 | **3.0** | Q1 |
| 3 | C3-① | 정하늘 | 확인지연으로 자금계획 불가 | 5 | 2 | **3.0** | Q1 |
| 5 | A2-② | 정민재★ | 격차 설명 부재 | 4 | 2 | **2.4** | Q1 |
| 5 | C2-① | 이수경 | 다건 동시추적 불가 | 4 | 2 | **2.4** | Q1 |
| 5 | C4-① | 한지원 | 원가 불확실 | 4 | 2 | **2.4** | Q1 |
| 5 | C5-① | 오세훈 | 세 마찰 동시체감 | 4 | 2 | **2.4** | Q1 |
| 5 | A1-② | 이영재 | 개인·회사 경험 괴리 | 4 | 2 | **2.4** | Q1 |
| 5 | A1-④ | 이영재 | 부서간 사일로 | 3 | 1 | **2.4** | Q1 |
| 5 | A3-② | 한도윤 | 본사·지사 격차 | 4 | 2 | **2.4** | Q1 |
| 5 | A3-⑤ | 한도윤 | 장기 보류 | 3 | 1 | **2.4** | Q1 |
| 5 | N2-③ | 오현석 | 자금노출 리스크 | 4 | 2 | **2.4** | Q1 |
| 14 | A2-④ | 정민재★ | 규제 불확실성 지연 | 3 | 2 | **1.8** | Q1 |
| 14 | A3-④ | 한도윤 | 국내안건에 밀림 | 3 | 2 | **1.8** | Q1 |
| 14 | E2-③ | 배소연 | 특급송금 반복 비용 | 3 | 2 | **1.8** | Q1 |
| 17 | C1-⑤ | 김민준★ | 전환에 별도 협상 필요 | 3 | 3 | **1.2** | Q2 |
| 17 | A2-① | 정민재★ | PoC 일회성 | 3 | 3 | **1.2** | Q2 |
| 17 | C3-⑤ | 정하늘 | 협상력 약화 잔존 | 3 | 3 | **1.2** | Q2 |
| 17 | C4-④ | 한지원 | 절감폭 건별 편차 | 3 | 3 | **1.2** | Q2 |
| 17 | C5-④ | 오세훈 | 미도입 코리도 잔존 | 3 | 3 | **1.2** | Q2 |
| 17 | A1-⑤ | 이영재 | 반복 누적되는 아쉬움 | 2 | 2 | **1.2** | Q3 |
| 17 | N2-⑤ | 오현석 | 레퍼런스 부재시 보류 | 2 | 2 | **1.2** | Q3 |
| 24 | E1-⑥ | 강태민★ | 예외율 재검토 리스크 | 2 | 3 | **0.8** | Q4 |
| 24 | C2-⑤ | 이수경 | 예외 건 수동 처리 잔존 | 2 | 3 | **0.8** | Q4 |
| 24 | C4-⑤ | 한지원 | 헤지비용 부담 잔존 | 2 | 3 | **0.8** | Q4 |
| 24 | C5-⑤ | 오세훈 | 전환기 병행 부담 | 2 | 3 | **0.8** | Q4 |
| 24 | E2-⑤ | 배소연 | 옵션 비용 부담 | 2 | 3 | **0.8** | Q4 |
| 24 | N2-① | 오현석 | 대안 확신 없음 | 2 | 3 | **0.8** | Q4 |
| 30 | C1-⑥ | 김민준★ | 락인 리스크 | 2 | 4 | **0.4** | Q4 |
| 30 | E1-⑤ | 강태민★ | 승인 부담 잔존 | 2 | 4 | **0.4** | Q4 |
| 30 | N1-③ | 최지훈★ | 리스크>기대이득 | 2 | 4 | **0.4** | Q4 |
| 30 | C2-④ | 이수경 | 초기 데이터 정합성 우려 | 2 | 4 | **0.4** | Q4 |
| 30 | C3-⑥ | 정하늘 | 락인 우려 | 2 | 4 | **0.4** | Q4 |
| 35 | N1-① | 최지훈★ | 문제인식 자체가 낮음 | 1 | 5 | **0.0** | Q4 |
| 35 | N1-④ | 최지훈★ | 전환 거부 | 3 | 5 | **0.0** | Q2 |
