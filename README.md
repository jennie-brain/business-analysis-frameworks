...
- [~] 06 - 시장기회 분석 : 기회점수(OS) 기반 우선순위 판단 — AOS·DOS 방법론 정리 완료, 05챕터 1차 생성 12명 전원에서 대표 Pain 36개(3개씩)를 뽑아 Importance·Satisfaction·AOS 산출 및 사분면 매트릭스 작성 완료(Q1 혁신기회 16건·Q2 6건·Q3 2건·Q4 12건). DOS·JTBD 연계는 다음 회차 (`06_시장기회분석/`)
- [ ] 07 - 미착수
