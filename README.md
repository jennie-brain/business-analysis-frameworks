...
## 리서치 방법론 실습 (챕터 목록과 별개 트랙)

- `00_리서치전략_7단계_B2B국경간결제/` — "AI 협업 리서치 7단계 전략"(광범위한 탐색→범위 축소→핵심 원인 분석→가설 수립→정량적 검증→반복적 정제→솔루션 구체화)을 'B2B 국경간 이종통화 결제·정산 인프라 시장' 사례에 적용한 실습 기록. 현재 1~4단계까지 진행.
